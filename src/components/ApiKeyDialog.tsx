        ...
        <Dialog.Content className="fixed bg-white left-1/2 top-1/2 max-h-[85vh] w-[90vw] max-w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-md bg-gray1 p-[25px] shadow-[var(--shadow-6)] focus:outline-none data-[state=open]:animate-contentShow">
          ...
          <div className="mt-[25px] flex justify-end gap-2">
            <Dialog.Close asChild>
              <button
                className="cursor-pointer inline-flex h-[35px] items-center justify-center rounded bg-gray4 px-[15px] font-medium leading-none text-gray11 outline-none outline-offset-1 hover:bg-gray5 focus-visible:outline-2 focus-visible:outline-gray6 select-none"
              >
                Cancel
              </button>
            </Dialog.Close>
